...
function wp_enqueue_scripts_example() {
    ...
    wp_enqueue_script( 'owl-carousel-js', get_stylesheet_directory_uri() . '/library/js/owl.carousel.js' );
    ...
    wp_enqueue_style( 'owl-carousel-css', get_stylesheet_directory_uri() . '/library/css/owl.carousel.css' );
    wp_enqueue_style( 'owl-theme', get_stylesheet_directory_uri() . '/library/css/owl.theme.css' );

	...
	<div class="container">
		...
		<div id="enfermeria-domiciliaria">
			...
			<div class="seven columns">
				...
				<h4><img width="15" src="<?php bloginfo('template_url' ); ?>/library/img/circle_2.png" alt="">&nbsp;&nbsp;TERAPIA RESPIRATORIA Y FÍSICA</h4>

				<h4><img width="15" src="<?php bloginfo('template_url' ); ?>/library/img/circle_1.png" alt="">&nbsp;&nbsp;SERVICIO DE TRANSPORTE</h4>
				<p>
